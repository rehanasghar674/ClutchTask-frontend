...
const TaskListUser = () => {
  ...
  return (
    <>
      <AuthLayout>
        <div className="px-3">
          <div className="bg-white shadow-md rounded-md w-full md:py-0 px-5 md:px-4 py-3 mt-5 md:mt-3 sticky top-0 left-0 z-50">
            <form
              onSubmit={handleSubmit(onSubmit)}
              className="flex justify-between flex-col md:flex-row md:items-center lg:px-2">
              <div>
                <input
                  type="search"
                  className="w-full md:w-[330px] lg:w-[320px] outline-0 rounded-md px-2 py-1 bg-gray-100"
